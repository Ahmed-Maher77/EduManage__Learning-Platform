	...
	render() {
		return (
			<>
				...
				<nav
					className="main-navbar navbar navbar-expand-lg px-3"
					role="navigation"
				...
				>
					<div className="container-fluid">
						...
						<NavLink
							...
							to="/"
							aria-label="EduManage - Go to homepage"
						>
							<div className="brand-icon me-2" aria-hidden="true">
								<svg
									width="32"
									height="32"
									viewBox="0 0 24 24"
						...
						>
							...
							<span id="menu-description" className="sr-only">
								Click to expand or collapse the navigation menu
							</span>
						</button>
							...
							>
								...
								<li className="nav-item" role="none">
									<NavLink
										...
										to="/instructors"
										role="menuitem"
										aria-label="Go to Instructors page"
									>
										<svg
											width="18"
											height="18"
